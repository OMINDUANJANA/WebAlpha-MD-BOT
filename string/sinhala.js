	...
	manoj: {
		...
		start: {
			shutdown: {
				...
				done: '*⛔ Web Alpha  Whatsapp Bot ක්‍රියාවිරහිත වේ..*',
			},
			start: {
				desc: 'බොට්ව නැවත පනගන්වන්න',
				boot: '```බූට් කිරීම...```',
				done: '*Omindu Web Alpha Whatsapp Bot සාර්ථකව පනගැන්වින.!*'
			}
		},
		stick_cmd: {
		...
		update: {
			...
			updating: '*Web Alpha Whatsapp Bot දැන් යාවත්කාලීන වෙමින් පවතී...*',
			update: '*යාවත්කාලීනයක් නොමැත..*\n*ඔබේ බොට් එක සම්පූර්ණයෙන්ම යාවත්කාලීනයි!*',
			updated: '*Web Alpha Whatsapp Bot සාර්ථකව යාවත්කාලීන කර ඇත..*',
